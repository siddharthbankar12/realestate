    ...
    <>
      ...
      <section className={styles.Gallery}>
        <div className={styles.images}>
          <img className={styles.image} src="/web16-2@2x.png" alt="Gallery Image" />
          <img className={styles.image} src="/web18-3@2x.png" alt="Gallery Image" />
          <img className={styles.image} src="/web21-1@2x.png" alt="Gallery Image" />
          <img className={styles.image} src="/web19-1@2x.png" alt="Gallery Image" />
          <img className={styles.image} src="/web17-1@2x.png" alt="Gallery Image" />
          <img className={styles.image} src="/web20-1@2x.png" alt="Gallery Image" />
          <img className={styles.image} src="/web16-2@2x.png" alt="Gallery Image" />
          <img className={styles.image} src="/web18-3@2x.png" alt="Gallery Image" />
          <img className={styles.image} src="/web21-1@2x.png" alt="Gallery Image" />
          <img className={styles.image} src="/web19-1@2x.png" alt="Gallery Image" />
          ...
          <section className={styles.FacilitiesAmenities}>
            ...
            <div className={styles.gridContainer}>
              <div className={styles.gridItem}>
                <img className={styles.img} src="/image-5@2x.png" alt="Elevator" />
                <div className={styles.facilityamenity}>Elevator</div>
              </div>
              <div className={styles.gridItem}>
                <img className={styles.img} src="/image-61@2x.png" alt="Library" />
                <div className={styles.facilityamenity}>Library</div>
              </div>
              <div className={styles.gridItem}>
                <img className={styles.img} src="/image-8@2x.png" alt="Laundry Room" />
                <div className={styles.facilityamenity}>Laundry Room</div>
              </div>
              <div className={styles.gridItem}>
                <img className={styles.img} src="/image-11@2x.png" alt="24/7 CCTV Surveillance" />
                <div className={styles.facilityamenity}>24/7 CCTV Surveillance</div>
              </div>
              <div className={styles.gridItem}>
                <img className={styles.img} src="/image-7@2x.png" alt="Reception" />
                <div className={styles.facilityamenity}>Reception</div>
              </div>
              <div className={styles.gridItem}>
                <img className={styles.img} src="/image-8@2x.png" alt="Lorem, ipsum dolor." />
                <div className={styles.facilityamenity}>Lorem, ipsum dolor.</div>
              </div>
              <div className={styles.gridItem}>
                <img className={styles.img} src="/image-9@2x.png" alt="Wifi Connectivity" />
                <div className={styles.facilityamenity}>Wifi Connectivity</div>
              </div>
              <div className={styles.gridItem}>
                <img className={styles.img} src="/image-10@2x.png" alt="Basketball Court" />
